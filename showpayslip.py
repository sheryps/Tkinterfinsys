...
def edit_payslip():  
    ...
    label1=Entry(F,bg='#2f516a',fg='#fff',textvariable=provi, font=('times new roman', 11, 'bold'))
    ...
    label1=Entry(F,bg='#2f516a',fg='#fff',textvariable=prof, font=('times new roman', 11, 'bold'))
    ...
    label1=Entry(F,bg='#2f516a',fg='#fff',textvariable=esi, font=('times new roman', 11, 'bold'))
