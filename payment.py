...
full_frame = Frame(mycanvas, width=1500, height=2000, bg='#2f516a')
...
payee_input = Entry(form_frame, width=49, bg='#243e55', fg='#fff')
...
place_input = StringVar()
drop4 = ttk.Combobox(form_frame, textvariable=place_input)

drop4['values'] = ("Cash Cheque Debit_Card Credit_Card")

payment_method_lab.place(x=530, y=300, height=15, width=120)
