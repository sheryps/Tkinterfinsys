...
def generate_payslip():  
    ...
    empname=StringVar(form_frame) 
    employeenumber=StringVar(form_frame) 
    desig=StringVar(form_frame) 
    fper=StringVar(form_frame) 
    tper=StringVar(form_frame) 
    paydate=StringVar(form_frame) 
    basic=StringVar(form_frame) 
    da=StringVar(form_frame) 
    ear1=StringVar(form_frame) 
    earr1=StringVar(form_frame) 
    ear2=StringVar(form_frame) 
    earr2=StringVar(form_frame) 
    ear3=StringVar(form_frame) 
    earr3=StringVar(form_frame) 
    ear4=StringVar(form_frame) 
    earr4=StringVar(form_frame) 
    ear5=StringVar(form_frame) 
    earr5=StringVar(form_frame) 
    ear6=StringVar(form_frame) 
    earr6=StringVar(form_frame) 
    ear7=StringVar(form_frame) 
    earr7=StringVar(form_frame) 
    provi=StringVar(form_frame) 
    prof=StringVar(form_frame) 
    esi=StringVar(form_frame) 
    ded1=StringVar(form_frame) 
    dedu1=StringVar(form_frame) 
    ded2=StringVar(form_frame) 
    dedu2=StringVar(form_frame) 
    ded3=StringVar(form_frame) 
    dedu3=StringVar(form_frame) 
    ded4=StringVar(form_frame) 
    dedu4=StringVar(form_frame) 
    ded5=StringVar(form_frame) 
    dedu5=StringVar(form_frame) 
    ded6=StringVar(form_frame) 
    dedu6=StringVar(form_frame) 
    gros=StringVar(form_frame) 
    tded=StringVar(form_frame) 
    netsal=StringVar(form_frame) 
