...
def profitloss():
    ...
    drop.place(relx=0.05,rely=0.23,relwidth=0.3,relheight=0.15)
     #buttons
    tk.Button(form_frame,text = "Run Report",bg="#243e55",fg="#fff",font=('times new roman', 16, 'bold'),command=profitlossdata).place(relx=0.55,rely=0.5,relwidth=0.15)
    ...
    def allprofitvalues():
        ...
        def expenses():
            ...
            tot3=0.0
            try:
                cursor.execute("SELECT name,balance FROM accounts1 WHERE acctype =%s and cid =%s",([nmeee,cid]))
                ...
                pass
            try:
                cursor.execute("SELECT name,balance FROM accounts WHERE acctype =%s and cid =%s",([nmeee,cid]))
        ...
        def otherexpenses():
            nmee1='Other Expenses'
            global v,tot4
            v=w+0.04
            tot4=0.0
            try:
                cursor.execute("SELECT name,balance FROM accounts1 WHERE acctype =%s and cid =%s",([nmee1,cid]))
                val8=cursor.fetchall()
                for i in val8:
                ...
                pass
            try:
                cursor.execute("SELECT name,balance FROM accounts WHERE acctype =%s and cid =%s",([nmee1,cid]))
                val9=cursor.fetchall()
                for i in val9:
                    tk.Label(contframe,text=i[0],bg="#FFFFFF",font=('times new roman', 14)).place(relx=0.08,rely=v)
                    tk.Label(contframe,text = i[1],bg="#FFFFFF",font=('times new roman', 12)).place(relx=0.86,rely=v)
                    v=v+0.04
    ...
    def betweendates():
        ...
        tk.Label(contframe1,text = "Income",bg="#FFFFFF",font=('times new roman', 16)).place(relx=0.03,rely=0.04)
        tk.Label(contframe1,text = " Total Income",bg="grey",font=('times new roman', 14)).place(relx=0.06,rely=0.08)
        tk.Label(contframe1,text = totalincome,bg="grey",font=('times new roman', 12)).place(relx=0.88,rely=0.08)
        tk.Label(contframe1,text = " Cost of Goods Sold ",bg="#FFFFFF",font=('times new roman', 16)).place(relx=0.03,rely=0.12)
        tk.Label(contframe1,text = costofgoods,bg="grey",font=('times new roman', 12)).place(relx=0.88,rely=0.12)
        tk.Label(contframe1,text = " Gross Profit ",bg="grey",font=('times new roman', 14)).place(relx=0.06,rely=0.16)
        tk.Label(contframe1,text = gropro,bg="grey",font=('times new roman', 12)).place(relx=0.88,rely=0.16)
        tk.Label(contframe1,text = "Expenses",bg="#FFFFFF",font=('times new roman', 16)).place(relx=0.03,rely=0.2)
        tk.Label(contframe1,text = "TOTAL EXPENSE",bg="#FFFFFF",font=('times new roman', 16)).place(relx=0.03,rely=0.24)
        tk.Label(contframe1,text = totaloexpense,bg="#FFFFFF",font=('times new roman', 12)).place(relx=0.88,rely=0.24) 
        tk.Label(contframe1,text = "PROFIT OR LOSS",bg="#FFFFFF",font=('times new roman', 16)).place(relx=0.03,rely=0.28)
        tk.Label(contframe1,text = profandloss ,bg="#FFFFFF",font=('times new roman', 12)).place(relx=0.88,rely=0.28) 
