...
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Vehicles')",([month_name3]))
tab315 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Vehicles')",([month_name2]))
tab316 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Vehicles')",([month_name1]))
tab317 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Vehicles')",([month_name]))
...
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='CGST Payable')",([month_name4]))
tab320 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='CGST Payable')",([month_name3]))
tab321 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='CGST Payable')",([month_name2]))
tab322 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='CGST Payable')",([month_name1]))
tab323 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='CGST Payable')",([month_name]))
...
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='CST Payable')",([month_name4]))
tab326 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='CST Payable')",([month_name3]))
tab327 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='CST Payable')",([month_name2]))
tab328 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='CST Payable')",([month_name1]))
tab329 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='CST Payable')",([month_name]))
...
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='CST Suspense')",([month_name4]))
tab332 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='CST Suspense')",([month_name3]))
tab333 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='CST Suspense')",([month_name2]))
tab334 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='CST Suspense')",([month_name1]))
tab335 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='CST Suspense')",([month_name]))
...
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='GST Payable')",([month_name4]))
tab338 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='GST Payable')",([month_name3]))
tab339 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='GST Payable')",([month_name2]))
tab340 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='GST Payable')",([month_name1]))
tab341 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='GST Payable')",([month_name]))
...
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='GST Suspense')",([month_name4]))
tab344 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='GST Suspense')",([month_name3]))
tab345 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='GST Suspense')",([month_name2]))
tab346 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='GST Suspense')",([month_name1]))
tab347 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='GST Suspense')",([month_name]))
...
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='IGST Payable')",([month_name4]))
tab350 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='IGST Payable')",([month_name3]))
tab351 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='IGST Payable')",([month_name2]))
tab352 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='IGST Payable')",([month_name1]))
tab353 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='IGST Payable')",([month_name]))
...
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input CGST')",([month_name4]))
tab356 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input CGST')",([month_name3]))
tab357 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input CGST')",([month_name2]))
tab358 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input CGST')",([month_name1]))
tab359 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input CGST')",([month_name]))
...
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input CGST Tax RCM')",([month_name4]))
tab362 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input CGST Tax RCM')",([month_name3]))
tab363 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input CGST Tax RCM')",([month_name2]))
tab364 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input CGST Tax RCM')",([month_name1]))
tab365 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input CGST Tax RCM')",([month_name]))
...
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input IGST')",([month_name4]))
tab368 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input IGST')",([month_name3]))
tab369 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input IGST')",([month_name2]))
tab370 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input IGST')",([month_name1]))
tab371 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input IGST')",([month_name]))
...
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input IGST Tax RCM')",([month_name4]))
tab374 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input IGST Tax RCM')",([month_name3]))
tab375 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input IGST Tax RCM')",([month_name2]))
tab376 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input IGST Tax RCM')",([month_name1]))
tab377 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input IGST Tax RCM')",([month_name]))
...
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input Krishi Kalyan Cess')",([month_name4]))
tab380 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input Krishi Kalyan Cess')",([month_name3]))
tab381 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input Krishi Kalyan Cess')",([month_name2]))
tab382 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input Krishi Kalyan Cess')",([month_name1]))
tab383 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input Krishi Kalyan Cess')",([month_name]))
...
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input Krishi Kalyan Cess RCM')",([month_name4]))
tab386 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input Krishi Kalyan Cess RCM')",([month_name3]))
tab387 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input Krishi Kalyan Cess RCM')",([month_name2]))
tab388 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input Krishi Kalyan Cess RCM')",([month_name1]))
tab389 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input Krishi Kalyan Cess RCM')",([month_name]))
...
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input Service Tax')",([month_name4]))
tab392 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input Service Tax')",([month_name3]))
tab393 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input Service Tax')",([month_name2]))
tab394 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input Service Tax')",([month_name1]))
tab395 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input Service Tax')",([month_name]))
...
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input Service Tax RCM')",([month_name4]))
tab398 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input Service Tax RCM')",([month_name3]))
tab399 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input Service Tax RCM')",([month_name2]))
tab400 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input Service Tax RCM')",([month_name1]))
tab401 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input Service Tax RCM')",([month_name]))
...
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input SGST')",([month_name4]))
tab404 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input SGST')",([month_name3]))
tab405 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input SGST')",([month_name2]))
tab406 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input SGST')",([month_name1]))
tab407 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input SGST')",([month_name]))
tab408 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input SGST')",([full_month_name]))
tab409 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input SGST Tax RCM')",([month_name4]))
tab410 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input SGST Tax RCM')",([month_name3]))
tab411 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input SGST Tax RCM')",([month_name2]))
tab412 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input SGST Tax RCM')",([month_name1]))
tab413 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input SGST Tax RCM')",([month_name]))
tab414 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input SGST Tax RCM')",([full_month_name]))
tab415 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input VAT 14%')",([month_name4]))
tab416 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input VAT 14%')",([month_name3]))
tab417 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input VAT 14%')",([month_name2]))
tab418 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input VAT 14%')",([month_name1]))
tab419 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input VAT 14%')",([month_name]))
tab420 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input VAT 14%')",([full_month_name]))
tab421 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input VAT 4%')",([month_name4]))
tab422 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input VAT 4%')",([month_name3]))
tab423 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input VAT 4%')",([month_name2]))
tab424 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input VAT 4%')",([month_name1]))
tab425 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input VAT 4%')",([month_name]))
tab426 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input VAT 4%')",([full_month_name]))
tab427 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input VAT 5%')",([month_name4]))
tab428 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input VAT 5%')",([month_name3]))
tab429 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input VAT 5%')",([month_name2]))
tab430 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input VAT 5%')",([month_name1]))
tab431 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input VAT 5%')",([month_name]))
tab432 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Input VAT 5%')",([full_month_name]))
tab433 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Krishi Kalyan Cess Payable')",([month_name4]))
tab434 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Krishi Kalyan Cess Payable')",([month_name3]))
tab435 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Krishi Kalyan Cess Payable')",([month_name2]))
tab436 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Krishi Kalyan Cess Payable')",([month_name1]))
tab437 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Krishi Kalyan Cess Payable')",([month_name]))
tab438 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Krishi Kalyan Cess Payable')",([full_month_name]))
tab439 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Krishi Kalyan Cess Suspense')",([month_name4]))
tab440 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Krishi Kalyan Cess Suspense')",([month_name3]))
tab441 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Krishi Kalyan Cess Suspense')",([month_name2]))
tab442 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Krishi Kalyan Cess Suspense')",([month_name1]))
tab443 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Krishi Kalyan Cess Suspense')",([month_name]))
tab444 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Krishi Kalyan Cess Suspense')",([full_month_name]))
tab445 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output CGST')",([month_name4]))
tab446 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output CGST')",([month_name3]))
tab447 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output CGST')",([month_name2]))
tab448 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output CGST')",([month_name1]))
tab449 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output CGST')",([month_name]))
tab450 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output CGST')",([full_month_name]))
tab451 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output CGST Tax RCM')",([month_name4]))
tab452 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output CGST Tax RCM')",([month_name3]))
tab453 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output CGST Tax RCM')",([month_name2]))
tab454 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output CGST Tax RCM')",([month_name1]))
tab455 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output CGST Tax RCM')",([month_name]))
tab456 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output CGST Tax RCM')",([full_month_name]))
tab457 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output CST 2%')",([month_name4]))
tab458 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output CST 2%')",([month_name3]))
tab459 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output CST 2%')",([month_name2]))
tab460 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output CST 2%')",([month_name1]))
tab461 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output CST 2%')",([month_name]))
tab462 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output CST 2%')",([full_month_name]))
tab463 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output IGST')",([month_name4]))
tab464 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output IGST')",([month_name3]))
tab465 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output IGST')",([month_name2]))
tab466 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output IGST')",([month_name1]))
tab467 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output IGST')",([month_name]))
tab468 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output IGST')",([full_month_name]))
tab469 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output IGST Tax RCM')",([month_name4]))
tab470 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output IGST Tax RCM')",([month_name3]))
tab471 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output IGST Tax RCM')",([month_name2]))
tab472 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output IGST Tax RCM')",([month_name1]))
tab473 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output IGST Tax RCM')",([month_name]))
tab474 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output IGST Tax RCM')",([full_month_name]))
tab475 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output Krishi Kalyan Cess')",([month_name4]))
tab476 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output Krishi Kalyan Cess')",([month_name3]))
tab477 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output Krishi Kalyan Cess')",([month_name2]))
tab478 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output Krishi Kalyan Cess')",([month_name1]))
tab479 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output Krishi Kalyan Cess')",([month_name]))
tab480 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output Krishi Kalyan Cess')",([full_month_name]))
tab481 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output Krishi Kalyan Cess RCM')",([month_name4]))
tab482 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output Krishi Kalyan Cess RCM')",([month_name3]))
tab483 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output Krishi Kalyan Cess RCM')",([month_name2]))
tab484 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output Krishi Kalyan Cess RCM')",([month_name1]))
tab485 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output Krishi Kalyan Cess RCM')",([month_name]))
tab486 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output Krishi Kalyan Cess RCM')",([full_month_name]))
tab487 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output Service Tax')",([month_name4]))
tab488 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output Service Tax')",([month_name3]))
tab489 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output Service Tax')",([month_name2]))
tab490 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output Service Tax')",([month_name1]))
tab491 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output Service Tax')",([month_name]))
tab492 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output Service Tax')",([full_month_name]))
tab493 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output Service Tax RCM')",([month_name4]))
tab494 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output Service Tax RCM')",([month_name3]))
tab495 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output Service Tax RCM')",([month_name2]))
tab496 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output Service Tax RCM')",([month_name1]))
tab497 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output Service Tax RCM')",([month_name]))
tab498 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output Service Tax RCM')",([full_month_name]))
tab499 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output SGST')",([month_name4]))
tab500 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output SGST')",([month_name3]))
tab501 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output SGST')",([month_name2]))
tab502 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output SGST')",([month_name1]))
tab503 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output SGST')",([month_name]))
tab504 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output SGST')",([full_month_name]))
tab505 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output SGST Tax RCM')",([month_name4]))
tab506 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output SGST Tax RCM')",([month_name3]))
tab507 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output SGST Tax RCM')",([month_name2]))
tab508 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output SGST Tax RCM')",([month_name1]))
tab509 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output SGST Tax RCM')",([month_name]))
tab510 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output SGST Tax RCM')",([full_month_name]))
tab511 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output VAT 14%')",([month_name4]))
tab512 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output VAT 14%')",([month_name3]))
tab513 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output VAT 14%')",([month_name2]))
tab514 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output VAT 14%')",([month_name1]))
tab515 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output VAT 14%')",([month_name]))
tab516 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output VAT 14%')",([full_month_name]))
tab517 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output VAT 4%')",([month_name4]))
tab518 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output VAT 4%')",([month_name3]))
tab519 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output VAT 4%')",([month_name2]))
tab520 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output VAT 4%')",([month_name1]))
tab521 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output VAT 4%')",([month_name]))
tab522 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output VAT 4%')",([full_month_name]))
tab523 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output VAT 5%')",([month_name4]))
tab524 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output VAT 5%')",([month_name3]))
tab525 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output VAT 5%')",([month_name2]))
tab526 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output VAT 5%')",([month_name1]))
tab527 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output VAT 5%')",([month_name]))
tab528 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Output VAT 5%')",([full_month_name]))
tab529 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Service Tax Payable')",([month_name4]))
tab530 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Service Tax Payable')",([month_name3]))
tab531 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Service Tax Payable')",([month_name2]))
tab532 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Service Tax Payable')",([month_name1]))
tab533 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Service Tax Payable')",([month_name]))
tab534 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Service Tax Payable')",([full_month_name]))
tab535 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Service Tax Suspense')",([month_name4]))
tab536 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Service Tax Suspense')",([month_name3]))
tab537 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Service Tax Suspense')",([month_name2]))
tab538 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Service Tax Suspense')",([month_name1]))
tab539 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Service Tax Suspense')",([month_name]))
tab540 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Service Tax Suspense')",([full_month_name]))
tab541 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='SGST Payable')",([month_name4]))
tab542 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='SGST Payable')",([month_name3]))
tab543 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='SGST Payable')",([month_name2]))
tab544 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='SGST Payable')",([month_name1]))
tab545 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='SGST Payable')",([month_name]))
tab546 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='SGST Payable')",([full_month_name]))
tab547 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Swachh Bharat Cess Payable')",([month_name4]))
tab548 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Swachh Bharat Cess Payable')",([month_name3]))
tab549 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Swachh Bharat Cess Payable')",([month_name2]))
tab550 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Swachh Bharat Cess Payable')",([month_name1]))
tab551 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Swachh Bharat Cess Payable')",([month_name]))
tab552 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Swachh Bharat Cess Payable')",([full_month_name]))
tab553 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Swachh Bharat Cess Suspense')",([month_name4]))
tab554 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Swachh Bharat Cess Suspense')",([month_name3]))
tab555 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Swachh Bharat Cess Suspense')",([month_name2]))
tab556 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Swachh Bharat Cess Suspense')",([month_name1]))
tab557 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Swachh Bharat Cess Suspense')",([month_name]))
tab558 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Swachh Bharat Cess Suspense')",([full_month_name]))
tab559 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='TDS Payable')",([month_name4]))
tab560 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='TDS Payable')",([month_name3]))
tab561 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='TDS Payable')",([month_name2]))
tab562 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='TDS Payable')",([month_name1]))
tab563 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='TDS Payable')",([month_name]))
tab564 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='TDS Payable')",([full_month_name]))
tab565 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='VAT Suspense')",([month_name4]))
tab566 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='VAT Suspense')",([month_name3]))
tab567 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='VAT Suspense')",([month_name2]))
tab568 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='VAT Suspense')",([month_name1]))
tab569 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='VAT Suspense')",([month_name]))
tab570 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='VAT Suspense')",([full_month_name]))
tab571 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Opening Balance Equity')",([month_name4]))
tab572 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Opening Balance Equity')",([month_name3]))
tab573 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Opening Balance Equity')",([month_name2]))
tab574 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Opening Balance Equity')",([month_name1]))
tab575 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Opening Balance Equity')",([month_name]))
tab576 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Opening Balance Equity')",([full_month_name]))
tab577 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Retained Earnings')",([month_name4]))
tab578 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Retained Earnings')",([month_name3]))
tab579 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Retained Earnings')",([month_name2]))
tab580 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Retained Earnings')",([month_name1]))
tab581 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Retained Earnings')",([month_name]))
tab582 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Retained Earnings')",([full_month_name]))
tab583 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Billable Expense Income')",([month_name4]))
tab584 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Billable Expense Income')",([month_name3]))
tab585 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Billable Expense Income')",([month_name2]))
tab586 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Billable Expense Income')",([month_name1]))
tab587 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Billable Expense Income')",([month_name]))
tab588 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Billable Expense Income')",([full_month_name]))
tab589 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Consulting Income')",([month_name4]))
tab590 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Consulting Income')",([month_name3]))
tab591 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Consulting Income')",([month_name2]))
tab592 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Consulting Income')",([month_name1]))
tab593 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Consulting Income')",([month_name]))
tab594 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Consulting Income')",([full_month_name]))
tab595 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Product Sales')",([month_name4]))
tab596 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Product Sales')",([month_name3]))
tab597 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Product Sales')",([month_name2]))
tab598 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Product Sales')",([month_name1]))
tab599 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Product Sales')",([month_name]))
tab600 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Product Sales')",([full_month_name]))
tab601 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales')",([month_name4]))
tab602 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales')",([month_name3]))
tab603 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales')",([month_name2]))
tab604 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales')",([month_name1]))
tab605 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales')",([month_name]))
tab606 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales')",([full_month_name]))
tab607 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales - Hardware')",([month_name4]))
tab608 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales - Hardware')",([month_name3]))
tab609 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales - Hardware')",([month_name2]))
tab610 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales - Hardware')",([month_name1]))
tab611 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales - Hardware')",([month_name]))
tab612 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales - Hardware')",([full_month_name]))
tab613 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales - Software')",([month_name4]))
tab614 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales - Software')",([month_name3]))
tab615 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales - Software')",([month_name2]))
tab616 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales - Software')",([month_name1]))
tab617 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales - Software')",([month_name]))
tab618 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales - Software')",([full_month_name]))
tab619 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales - Support and Maintenance')",([month_name4]))
tab620 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales - Support and Maintenance')",([month_name3]))
tab621 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales - Support and Maintenance')",([month_name2]))
tab622 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales - Support and Maintenance')",([month_name1]))
tab623 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales - Support and Maintenance')",([month_name]))
tab624 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales - Support and Maintenance')",([full_month_name]))
tab625 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales Discounts')",([month_name4]))
tab626 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales Discounts')",([month_name3]))
tab627 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales Discounts')",([month_name2]))
tab628 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales Discounts')",([month_name1]))
tab629 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales Discounts')",([month_name]))
tab630 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales Discounts')",([full_month_name]))
tab631 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales of Product Income')",([month_name4]))
tab632 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales of Product Income')",([month_name3]))
tab633 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales of Product Income')",([month_name2]))
tab634 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales of Product Income')",([month_name1]))
tab635 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales of Product Income')",([month_name]))
tab636 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Sales of Product Income')",([full_month_name]))
tab637 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Uncategorised Income')",([month_name4]))
tab638 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Uncategorised Income')",([month_name3]))
tab639 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Uncategorised Income')",([month_name2]))
tab640 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Uncategorised Income')",([month_name1]))
tab641 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Uncategorised Income')",([month_name]))
tab642 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Uncategorised Income')",([full_month_name]))
tab643 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Cost of sales')",([month_name4]))
tab644 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Cost of sales')",([month_name3]))
tab645 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Cost of sales')",([month_name2]))
tab646 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Cost of sales')",([month_name1]))
tab647 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Cost of sales')",([month_name]))
tab648 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Cost of sales')",([full_month_name]))
tab649 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Equipment Rental for Jobs')",([month_name4]))
tab650 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Equipment Rental for Jobs')",([month_name3]))
tab651 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Equipment Rental for Jobs')",([month_name2]))
tab652 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Equipment Rental for Jobs')",([month_name1]))
tab653 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Equipment Rental for Jobs')",([month_name]))
tab654 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Equipment Rental for Jobs')",([full_month_name]))
tab655 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Freight and Shipping Costs')",([month_name4]))
tab656 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Freight and Shipping Costs')",([month_name3]))
tab657 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Freight and Shipping Costs')",([month_name2]))
tab658 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Freight and Shipping Costs')",([month_name1]))
tab659 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Freight and Shipping Costs')",([month_name]))
tab660 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Freight and Shipping Costs')",([full_month_name]))
tab661 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Merchant Account Fees')",([month_name4]))
tab662 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Merchant Account Fees')",([month_name3]))
tab663 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Merchant Account Fees')",([month_name2]))
tab664 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Merchant Account Fees')",([month_name1]))
tab665 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Merchant Account Fees')",([month_name]))
tab666 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Merchant Account Fees')",([full_month_name]))
tab667 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Purchases - Hardware for Resale')",([month_name4]))
tab668 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Purchases - Hardware for Resale')",([month_name3]))
tab669 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Purchases - Hardware for Resale')",([month_name2]))
tab670 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Purchases - Hardware for Resale')",([month_name1]))
tab671 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Purchases - Hardware for Resale')",([month_name]))
tab672 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Purchases - Hardware for Resale')",([full_month_name]))
tab673 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Purchases - Software for Resale')",([month_name4]))
tab674 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Purchases - Software for Resale')",([month_name3]))
tab675 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Purchases - Software for Resale')",([month_name2]))
tab676 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Purchases - Software for Resale')",([month_name1]))
tab677 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Purchases - Software for Resale')",([month_name]))
tab678 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Purchases - Software for Resale')",([full_month_name]))
tab679 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Subcontracted Services')",([month_name4]))
tab680 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Subcontracted Services')",([month_name3]))
tab681 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Subcontracted Services')",([month_name2]))
tab682 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Subcontracted Services')",([month_name1]))
tab683 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Subcontracted Services')",([month_name]))
tab684 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Subcontracted Services')",([full_month_name]))
tab685 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Tools and Craft Supplies')",([month_name4]))
tab686 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Tools and Craft Supplies')",([month_name3]))
tab687 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Tools and Craft Supplies')",([month_name2]))
tab688 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Tools and Craft Supplies')",([month_name1]))
tab689 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Tools and Craft Supplies')",([month_name]))
tab690 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Tools and Craft Supplies')",([full_month_name]))
tab691 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Finance Charge Income')",([month_name4]))
tab692 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Finance Charge Income')",([month_name3]))
tab693 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Finance Charge Income')",([month_name2]))
tab694 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Finance Charge Income')",([month_name1]))
tab695 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Finance Charge Income')",([month_name]))
tab696 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Finance Charge Income')",([full_month_name]))
tab697 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Insurance Proceeds Received')",([month_name4]))
tab698 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Insurance Proceeds Received')",([month_name3]))
tab699 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Insurance Proceeds Received')",([month_name2]))
tab700 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Insurance Proceeds Received')",([month_name1]))
tab701 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Insurance Proceeds Received')",([month_name]))
tab702 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Insurance Proceeds Received')",([full_month_name]))
tab703 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Interest Income')",([month_name4]))
tab704 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Interest Income')",([month_name3]))
tab705 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Interest Income')",([month_name2]))
tab706 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Interest Income')",([month_name1]))
tab707 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Interest Income')",([month_name]))
tab708 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Interest Income')",([full_month_name]))
tab709 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Proceeds from Sale of Assets')",([month_name4]))
tab710 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Proceeds from Sale of Assets')",([month_name3]))
tab711 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Proceeds from Sale of Assets')",([month_name2]))
tab712 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Proceeds from Sale of Assets')",([month_name1]))
tab713 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Proceeds from Sale of Assets')",([month_name]))
tab714 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Proceeds from Sale of Assets')",([full_month_name]))
tab715 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Shipping and Delivery Income')",([month_name4]))
tab716 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Shipping and Delivery Income')",([month_name3]))
tab717 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Shipping and Delivery Income')",([month_name2]))
tab718 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Shipping and Delivery Income')",([month_name1]))
tab719 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Shipping and Delivery Income')",([month_name]))
tab720 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Shipping and Delivery Income')",([full_month_name]))
tab721 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Ask My Accountant')",([month_name4]))
tab722 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Ask My Accountant')",([month_name3]))
tab723 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Ask My Accountant')",([month_name2]))
tab724 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Ask My Accountant')",([month_name1]))
tab725 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Ask My Accountant')",([month_name]))
tab726 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Ask My Accountant')",([full_month_name]))
tab727 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='CGST write-off')",([month_name4]))
tab728 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='CGST write-off')",([month_name3]))
tab729 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='CGST write-off')",([month_name2]))
tab730 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='CGST write-off')",([month_name1]))
tab731 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='CGST write-off')",([month_name]))
tab732 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='CGST write-off')",([full_month_name]))
tab733 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='GST write-off')",([month_name4]))
tab734 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='GST write-off')",([month_name3]))
tab735 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='GST write-off')",([month_name2]))
tab736 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='GST write-off')",([month_name1]))
tab737 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='GST write-off')",([month_name]))
tab738 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='GST write-off')",([full_month_name]))
tab739 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='IGST write-off')",([month_name4]))
tab740 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='IGST write-off')",([month_name3]))
tab741 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='IGST write-off')",([month_name2]))
tab742 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='IGST write-off')",([month_name1]))
tab743 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='IGST write-off')",([month_name]))
tab744 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='IGST write-off')",([full_month_name]))
tab745 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Miscellaneous Expense')",([month_name4]))
tab746 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Miscellaneous Expense')",([month_name3]))
tab747 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Miscellaneous Expense')",([month_name2]))
tab748 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Miscellaneous Expense')",([month_name1]))
tab749 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Miscellaneous Expense')",([month_name]))
tab750 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Miscellaneous Expense')",([full_month_name]))
tab751 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Political Contributions')",([month_name4]))
tab752 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Political Contributions')",([month_name3]))
tab753 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Political Contributions')",([month_name2]))
tab754 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Political Contributions')",([month_name1]))
tab755 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Political Contributions')",([month_name]))
tab756 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Political Contributions')",([full_month_name]))
tab757 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='SGST write-off')",([month_name4]))
tab758 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='SGST write-off')",([month_name3]))
tab759 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='SGST write-off')",([month_name2]))
tab760 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='SGST write-off')",([month_name1]))
tab761 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='SGST write-off')",([month_name]))
tab762 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='SGST write-off')",([full_month_name]))
tab763 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Tax write-off')",([month_name4]))
tab764 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Tax write-off')",([month_name3]))
tab765 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Tax write-off')",([month_name2]))
tab766 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Tax write-off')",([month_name1]))
tab767 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Tax write-off')",([month_name]))
tab768 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Tax write-off')",([full_month_name]))
tab769 = mycursor.fetchall()

mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Vehicle Expenses')",([month_name4]))
tab770 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Vehicle Expenses')",([month_name3]))
tab771 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Vehicle Expenses')",([month_name2]))
tab772 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Vehicle Expenses')",([month_name1]))
tab773 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Vehicle Expenses')",([month_name]))
tab774 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM app1_expences WHERE paymmethod='cash'AND monthname(paymdate)=%s AND(category1='Vehicle Expenses')",([full_month_name]))
...
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM `app1_bills` WHERE paymmethod='cash' AND monthname(paymdate)=%s ",([month_name4]))
table129 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM `app1_bills` WHERE paymmethod='cash' AND monthname(paymdate)=%s ",([month_name3]))
table130 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM `app1_bills` WHERE paymmethod='cash' AND monthname(paymdate)=%s ",([month_name2]))
table131 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM `app1_bills` WHERE paymmethod='cash' AND monthname(paymdate)=%s ",([month_name1]))
table132 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM `app1_bills` WHERE paymmethod='cash' AND monthname(paymdate)=%s ",([month_name]))
table133 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM `app1_bills` WHERE paymmethod='cash' AND monthname(paymdate)=%s ",([full_month_name]))
table134 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(grandtotal),3) FROM `app1_bills` WHERE paymmethod='cash' ")
table135 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(salegrandtotal),3) FROM `app1_salesrecpts` WHERE salepay='cash' AND monthname(saledate)=%s ",([month_name4]))
table136 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(salegrandtotal),3) FROM `app1_salesrecpts` WHERE salepay='cash' AND monthname(saledate)=%s ",([month_name3]))
table137 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(salegrandtotal),3) FROM `app1_salesrecpts` WHERE salepay='cash' AND monthname(saledate)=%s ",([month_name2]))
table138 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(salegrandtotal),3) FROM `app1_salesrecpts` WHERE salepay='cash' AND monthname(saledate)=%s ",([month_name1]))
table139 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(salegrandtotal),3) FROM `app1_salesrecpts` WHERE salepay='cash' AND monthname(saledate)=%s ",([month_name]))
table140 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(salegrandtotal),3) FROM `app1_salesrecpts` WHERE salepay='cash' AND monthname(saledate)=%s ",([full_month_name]))
table141 = mycursor.fetchall()
mycursor.execute("SELECT ROUND(SUM(salegrandtotal),3) FROM `app1_salesrecpts` WHERE salepay='cash' ")
...
menu= StringVar()
menu.set("Filter By")
drop= OptionMenu(form_frame, menu,"Date","Month","Month range",command=selected)
...
total129.set(table129)
total130=tk.StringVar()
total130.set(table130)
total131=tk.StringVar()
total131.set(table131)
total132=tk.StringVar()
total132.set(table132)
total133=tk.StringVar()
total133.set(table133)
total134=tk.StringVar()
total134.set(table134)
total135=tk.StringVar()
total135.set(table135)
total136=tk.StringVar()
total136.set(table136)
total137=tk.StringVar()
total137.set(table137)
total138=tk.StringVar()
total138.set(table138)
total139=tk.StringVar()
total139.set(table139)
total140=tk.StringVar()
total140.set(table140)
total141=tk.StringVar()
total141.set(table141)
total142=tk.StringVar()
total142.set(table142)

# am=[x+y for (x,y) in zip(table129,table136)]
am=[table136]+[table129]
print(am)
...
r3.place(x=80,y=370)
input1=Entry(form_frame,bg='#2f516a',textvariable=total129,fg='white',width=16,justify='center').place(x=395,y=375,height=40)
input2=Entry(form_frame,bg='#2f516a',textvariable=total30,fg='white',width=16,justify='center').place(x=515,y=375,height=40)
input3=Entry(form_frame,bg='#2f516a',textvariable=total131,fg='white',width=16,justify='center').place(x=645,y=375,height=40)
input4=Entry(form_frame,bg='#2f516a',textvariable=total132,fg='white',width=16,justify='center').place(x=775,y=375,height=40)
input5=Entry(form_frame,bg='#2f516a',textvariable=total133,fg='white',width=16,justify='center').place(x=895,y=375,height=40)
input6=Entry(form_frame,bg='#2f516a',textvariable=total134,fg='white',width=16,justify='center').place(x=1025,y=375,height=40)
input7=Entry(form_frame,bg='#2f516a',textvariable=total135,fg='white',width=16,justify='center').place(x=1155,y=375,height=40)


r4=Label(form_frame,text="Sales & Reciepts",bg='#243e55' ,fg="white",font=('Arial',16),justify='left')
r4.place(x=80,y=459)

input1=Entry(form_frame,bg='#2f516a',textvariable=total136,fg='white',width=16,justify='center').place(x=395,y=456,height=40)
input2=Entry(form_frame,bg='#2f516a',textvariable=total137,fg='white',width=16,justify='center').place(x=515,y=456,height=40)
input3=Entry(form_frame,bg='#2f516a',textvariable=total138,fg='white',width=16,justify='center').place(x=645,y=456,height=40)
input4=Entry(form_frame,bg='#2f516a',textvariable=total139,fg='white',width=16,justify='center').place(x=775,y=456,height=40)
input5=Entry(form_frame,bg='#2f516a',textvariable=total140,fg='white',width=16,justify='center').place(x=895,y=456,height=40)
input6=Entry(form_frame,bg='#2f516a',textvariable=total141,fg='white',width=16,justify='center').place(x=1025,y=456,height=40)
input7=Entry(form_frame,bg='#2f516a',textvariable=total142,fg='white',width=16,justify='center').place(x=1155,y=456,height=40)


r5=Label(form_frame,text="Total Cash\nInflows",bg='#243e55' ,fg="white",font=('Arial',16),justify='left')
r5.place(x=80,y=539)
...
r6=Label(form_frame,text="Cash Balance",bg='#243e55' ,fg="white",font=('Arial',16),justify='left')
r6.place(x=80,y=619)
...
# r7=Label(form_frame,text="",bg='#243e55' ,fg="white",font=('Arial',16),justify='left')
# r7.place(x=80,y=699)
...
# r144=Label(form_frame,text="",bg='#243e55' ,fg="white",font=('Arial',16),justify='left')
...
# r145=Label(form_frame,text="",bg='#243e55' ,fg="white",font=('Arial',16),justify='left')
