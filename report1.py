...
set = ttk.Treeview(form_frame,height=0)
...
my_label = Label(form_frame,text = "Income",bg="#FFFFFF")
my_label.place(x=160,y=290)
my_label = Label(form_frame,text = " total income",bg="#FFFFFF")
my_label.place(x=180,y=320)
my_label = Label(form_frame,text = " 0.0",bg="#FFFFFF")
my_label.place(x=975,y=320)
my_label = Label(form_frame,text = " Cost of Goods Sold ",bg="#FFFFFF")
my_label.place(x=160,y=360)
my_label = Label(form_frame,text = " Gross Profit ",bg="#FFFFFF")
my_label.place(x=180,y=390)
my_label = Label(form_frame,text = " 0.0",bg="#FFFFFF")
my_label.place(x=975,y=390)
my_label = Label(form_frame,text = " Other Income ",bg="#FFFFFF")
my_label.place(x=180,y=420)
my_label = Label(form_frame,text = " Expenses ",bg="#FFFFFF")
my_label.place(x=160,y=460)
my_label = Label(form_frame,text = " Other Expenses ",bg="#FFFFFF")
my_label.place(x=160,y=490)
my_label = Label(form_frame,text = "TOTAL EXPENSE ",bg="#FFFFFF")
my_label.place(x=160,y=540)
my_label = Label(form_frame,text = " 0.0",bg="#FFFFFF")
my_label.place(x=975,y=540)
my_label = Label(form_frame,text = "PROFIT OR LOSS ",bg="#FFFFFF")
my_label.place(x=160,y=570)
my_label = Label(form_frame,text = " 0.0",bg="#FFFFFF")
my_label.place(x=975,y=570)
